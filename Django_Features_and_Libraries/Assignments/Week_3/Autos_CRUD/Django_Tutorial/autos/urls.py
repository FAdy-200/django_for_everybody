...
urlpatterns = [
    ...
    path('lookup/create/', views.MakeCreateNew.as_view(), name='make_create'),
    path('lookup/<int:pk>/update/', views.MakeUpdateNew.as_view(), name='make_update'),
    path('lookup/<int:pk>/delete/', views.MakeDeleteNew.as_view(), name='make_delete'),
]